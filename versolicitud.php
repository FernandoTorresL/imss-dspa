<?php
  ...
  $page_title = 'Gesti&oacute;n Cuentas SINDO - Ver lote';
  ...
  if (!isset($_GET['id_solicitud'])) {
    echo '<p class="error">Sin parámetro de id_solicitud. Por favor <a href="indexCuentasSINDO.php">vuelve al inicio </a> para acceder correctamente a esta p&aacutegina.</p>';
    // Insert the page footer
    require_once('footer.php');
    exit();
  }
  ...
  echo '<p class="titulo1">Últimas solicitudes modificadas para la valija ' . $id_valija . '</p>';
  ...
  echo '<th># Valija</th><th># de Lote</th><th>Fecha captura</th><th>Delegación que envía</th><th>Subdelegación</th>';
  echo '<th>Primer apellido</th><th>Segundo apellido</th><th>Nombre</th>';
  echo '<th>Matrícula</th><th>CURP</th><th>Usuario</th>';
