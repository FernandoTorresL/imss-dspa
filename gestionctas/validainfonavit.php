...
// Start the session
  ...
  $page_title = 'Cargar Archivo Validador INFONAVIT';
  ...
  if (isset($_POST['submit'])) {
    ...
    */
    ...
    $query = "SELECT archivo, num_registros FROM dspa_archivos";
    //echo $query;
    ...
    while ($row = mysqli_fetch_array($data)) {
      ...
      if (isset($_SESSION['user_id'])) {
        ...
        echo '<td><a href="generareporte.php?archivo=' . $row['archivo'] . '&num_registros=' . $row['num_registros'] . '">Genera reporte detallado</a></td></tr>';
      }
      else {
        echo '</tr>';
      }
  ...
  <form enctype="multipart/form-data" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
    ...
    <fieldset>
      <legend>Cargar nuevo archivo de Acreditados INFONAVIT</legend>
      ...
      <?php if (!empty($old_layout)) {
          ...
          echo '<p class="error">No se encontró archivo de acreditados</p>';
        } 
      ?>
