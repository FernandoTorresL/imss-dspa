<?php
  ...
  define('CAPTCHA_NUMCHARS', 5);  // number of characters in pass-phrase
  define('CAPTCHA_WIDTH', 100);   // width of image. Add more width if increase CAPTCHA_NUMCHARS
  define('CAPTCHA_HEIGHT', 25);   // height of image. Add more height if increase CAPTCHA_NUMCHARS
  define('CAPTCHA_NUMDOTS', 200);   // dots in the image. Add more height if increase CAPTCHA_NUMCHARS
